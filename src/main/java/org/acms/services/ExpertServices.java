...
public class ExpertServices {
	...
	public String registerExpert(ExpertAdvisor expert)throws Exception{
		...
		expert.setConnections(0);
		
		Firestore db = FirestoreClient.getFirestore();
		DocumentReference docRef = db.collection("users").document(expert.getUsername());
		ApiFuture<WriteResult> result = docRef.set(expert);
